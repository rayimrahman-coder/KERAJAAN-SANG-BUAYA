...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const Scene1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene1Model, 0, '../../assets/sounds/BKD/scene1_bkd.mp3');
    const Scene2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene2Model, 1, '../../assets/sounds/BKD/scene2_bkd.mp3');
    const Scene3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene3Model, 2, '../../assets/sounds/BKD/scene3_bkd.mp3');
    const Scene4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene4Model, 3, '../../assets/sounds/BKD/scene4_bkd.mp3');
    const Scene5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene5Model, 4, '../../assets/sounds/BKD/scene5_bkd.mp3');
    const Scene6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene6Model, 5, '../../assets/sounds/BKD/scene6_bkd.mp3');
    const Scene7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene7Model, 6, '../../assets/sounds/BKD/scene7_bkd.mp3');
    const Scene8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene8Model, 7, '../../assets/sounds/BKD/scene8_bkd.mp3');
    const Scene9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene9Model, 8, '../../assets/sounds/BKD/scene9_bkd.mp3');
    const Scene10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene10Model, 9, '../../assets/sounds/BKD/scene10_bkd.mp3');
