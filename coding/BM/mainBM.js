...
const loadModel = async (path, scale = { x: 0.3, y: 0.3, z: 0.3 }, position = { x: 0, y: -0.4, z: 0 }) => {
  try {
...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const Scene1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene1Model, 0, '../../assets/sounds/BM/SCENE 1-BM.mp3');
    const Scene2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene2Model, 1, '../../assets/sounds/BM/SCENE 2-BM.mp3');
    const Scene3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene3Model, 2, '../../assets/sounds/BM/SCENE 3-BM.mp3');
    const Scene4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene4Model, 3, '../../assets/sounds/BM/SCENE 4-BM.mp3');
    const Scene5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene5Model, 4, '../../assets/sounds/BM/SCENE 5-BM.mp3');
    const Scene6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene6Model, 5, '../../assets/sounds/BM/SCENE 6-BM.mp3');
    const Scene7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene7Model, 6, '../../assets/sounds/BM/SCENE 7-BM.mp3');
    const Scene8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene8Model, 7, '../../assets/sounds/BM/SCENE 8-BM.mp3');
    const Scene9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene9Model, 8, '../../assets/sounds/BM/SCENE 9-BM.mp3');
    const Scene10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, Scene10Model, 9, '../../assets/sounds/BM/SCENE 10-BM.mp3');
